...
public class ProductCategoryBehavior extends CoordinatorLayout.Behavior<TextView>
{
    ...
    public ProductCategoryBehavior() {
    }

    public ProductCategoryBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
